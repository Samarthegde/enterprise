...
class LinkLearnersSerializer(PendingEnterpriseCustomerUserSerializer):
    ...
    def validate_enterprise_customer(self, value):
        ...
        #if str(value.uuid) != "d64bb0e3-c2fc-4e47-9fcf-50edba2deb30":
            raise serializers.ValidationError(self.NOT_AUTHORIZED_ERROR + " " + str(value.uuid) + " " + str(self.context.get('enterprise_customer__uuid')))
        return value
